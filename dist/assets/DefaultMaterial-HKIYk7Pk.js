const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HUDMaterial.glsl-B_q5cwZn.js","./index-DfbHrti0.js","./index-BvJJw9yZ.css","./OutputColorHighlightOID.glsl-nJyxdPiK.js","./videoUtils-cU4EhidN.js","./requestImageUtils-u4Aqvm3w.js","./basicInterfaces-N86vRvDz.js","./TextureFormat-1mYWTFa-.js","./BufferView-DC0-Ek1K.js","./mat4f64-q_b6UJoq.js","./Indices-Dsxde0L2.js","./triangle-D8bthidW.js","./sphere-zEQdUIAX.js","./mat3f64-B5o_lm6j.js","./vectorStacks-G3BOEW5v.js","./quatf64-aQ5IuZRd.js","./lineSegment-B7MjwvGV.js","./VertexAttribute-BfkzOMLV.js","./glsl-Cj7KC756.js","./BindType-BBwFZqyN.js","./ShaderOutput-Bdd80V3g.js","./renderState-BhZBTBem.js","./orientedBoundingBox-CZm44_7w.js","./quat-E2KRAGtC.js","./spatialReferenceEllipsoidUtils-BiGNSSVQ.js","./computeTranslationToOriginAndRotation-FO4_l2d4.js","./plane-CnqoTuV5.js","./boundedPlane-BgOnFcUu.js","./projectVectorToVector-DHeKJdwD.js","./projectPointToVector-DNds0D9L.js","./ShaderBuilder-BvbwZ2sE.js","./NormalAttribute.glsl-fYzQRaiO.js","./dehydratedFeatureUtils-B6Hi_fB3.js","./meshVertexSpaceUtils-4gZJ8pY2.js","./MeshLocalVertexSpace-DDYpX45c.js","./hydratedFeatures-B6cwfINf.js","./vec3f32-WCVSSNPR.js","./HUDMaterial-C-rk8ma6.js","./floatRGBA-CN2SiC89.js","./InterleavedLayout-sOqSTxIx.js","./types-BKo2foNY.js"])))=>i.map(i=>d[i]);
import{iB as ra,kw as Q,aI as ia,ko as Oe,kx as na,ie as Aa,fG as q,aZ as O,mB as Ga,_ as me,ha as sa,kf as ne,aa as c,ab as we,ad as Pa,d7 as re,e9 as Ra,ed as _e,ef as Da,ee as Fa,aq as ja,ia as Va,jT as Ba,k3 as _a,cV as Ha,bh as L,f2 as Wa,oI as Ua,sh as k,cB as qa,kk as He,kz as We,bx as Ya,bm as Ja,fn as Me,fC as Za,fp as Ue,bj as ka,ii as Xa,a$ as Ka}from"./index-DfbHrti0.js";import{O as Qa}from"./InterleavedLayout-sOqSTxIx.js";import{n as w,u as he,r as qe,o as Te,t as eo,C as ao}from"./ShaderOutput-Bdd80V3g.js";import{n as G,a as M,t as pe}from"./NormalAttribute.glsl-fYzQRaiO.js";import{a5 as oo,a6 as to,a7 as F,a8 as ro,a9 as io,aa as no,ab as se,ac as so,ad as lo,a1 as co,ae as uo,af as mo,g as D,k as ee,_ as B,ag as _,ah as H,b as K,h as $,ai as W,r as ho,e as po,aj as vo,A as V,ak as fo,al as la,d as ca,am as da,an as ua,ao as go,v as Ie,x as ve,ap as ma,aq as xo,q as le,ar as bo,as as wo,at as Ye,au as Se,l as Mo,o as z,av as p,aw as Le,ax as Ee,ay as ce,a2 as To,az as So,aA as yo,i as Ae,aB as Co,c as No,aC as ha,$ as de,aD as pa,aE as va,f as fa,a as ga,aF as xa,aG as ue,aH as ba,K as $o,aI as Eo,aJ as zo,F as Oo,aK as Io,aL as Lo,aM as Ao,aN as Go,aO as Po,aP as Ro,z as Do,B as R,C as m,D as Fo,E as ye,aQ as jo,N as Vo,aR as Bo,aS as _o,aT as Ho,O as Wo,W as Uo}from"./OutputColorHighlightOID.glsl-nJyxdPiK.js";import{n as i,t as v}from"./glsl-Cj7KC756.js";import{i as N,a as Je,e as ae,n as oe}from"./basicInterfaces-N86vRvDz.js";import{e as b}from"./VertexAttribute-BfkzOMLV.js";import{e as Ge,r as Y}from"./mat3f64-B5o_lm6j.js";import{r as Ze}from"./mat4f64-q_b6UJoq.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-BvbwZ2sE.js";import{B as Pe,g as Re,f as qo}from"./renderState-BhZBTBem.js";function Yo(e){e.vertex.code.add(i`
...
}`);break;default:ra(a.doubleSidedMode);case T.COUNT:}}var T;(function(e){e[e.None=0]="None",e[e.View=1]="View",e[e.WindingOrder=2]="WindingOrder",e[e.COUNT=3]="COUNT"})(T||(T={}));function or({normalTexture:e,metallicRoughnessTexture:a,metallicFactor:t,roughnessFactor:r,emissiveTexture:o,emissiveFactor:n,occlusionTexture:s}){return e==null&&a==null&&o==null&&(n==null||ia(n,Oe))&&s==null&&(r==null||r===1)&&(t==null||t===1)}const Zo=Q(1,1,.5),tr=Q(0,.6,.2),rr=Q(0,1,.2);function wa(e,a){switch(a.normalType){case M.Attribute:case M.Compressed:e.include(pe,a),e.varyings.add("vNormalWorld","vec3"),e.varyings.add("vNormalView","vec3"),e.vertex.uniforms.add(new to("transformNormalGlobalFromModel",(t=>t.transformNormalGlobalFromModel)),new F("transformNormalViewFromGlobal",(t=>t.transformNormalViewFromGlobal))),e.vertex.code.add(i`void forwardNormal() {
vNormalWorld = transformNormalGlobalFromModel * normalModel();
vNormalView = transformNormalViewFromGlobal * vNormalWorld;
}`);break;case M.ScreenDerivative:e.vertex.code.add(i`void forwardNormal() {}`);break;default:ra(a.normalType);case M.COUNT:}}let ko=class extends oo{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Ge()}},Xo=class extends ro{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Ge(),this.toMapSpace=na()}};function Ma(e){e.vertex.code.add(i`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
forwardObjectAndLayerIdColor();`),e.include(U,a),r.main.add(i`
        ...
        ${d===w.ObjectAndLayerIdColor?i`outputObjectAndLayerIdColor();`:i`outputDepth(depth);`}`);break;case w.Normal:{B(t,a),e.include(_,a),e.include(pe,a),e.include(wa,a),e.include(H,a),e.include(K,a),l&&r.uniforms.add(new $("tex",(S=>S.texture))),h===M.ScreenDerivative&&o.add("vPositionView","vec3",{invariant:!0});const g=h===M.Attribute||h===M.Compressed;t.main.add(i`
...
}`))}function hr(e,a){e.include(Le),e.code.add(i`
...
return outColor;
}`);default:case p.COUNT:}}let ft=class extends Ae{constructor(a,t,r){super(a,"mat4",fe.Draw,((o,n,s,l)=>o.setUniformMatrix4fv(a,t(n,s,l))),r)}},gt=class extends Ae{constructor(a,t,r){super(a,"mat4",fe.Pass,((o,n,s)=>o.setUniformMatrix4fv(a,t(n,s))),r)}};function xt(e){e.fragment.uniforms.add(new gt("shadowMapMatrix",((a,t)=>t.shadowMap.getShadowMapMatrices(a.origin)),4)),Ca(e)}function bt(e){e.fragment.uniforms.add(new ft("shadowMapMatrix",((a,t)=>t.shadowMap.getShadowMapMatrices(a.origin)),4)),Ca(e)}function Ca(e){const{fragment:a}=e;a.uniforms.add(new z("cascadeDistances",(t=>t.shadowMap.cascadeDistances)),new Co("numCascades",(t=>t.shadowMap.numCascades))),a.code.add(i`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
