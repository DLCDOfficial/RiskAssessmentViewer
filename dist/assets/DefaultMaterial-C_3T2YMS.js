const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HUDMaterial.glsl-D46kQOJB.js","./index-oQclEyX3.js","./index-rYCsHKDq.css","./OutputColorHighlightOID.glsl-i058ZB5n.js","./videoUtils-ZpV2qiL_.js","./requestImageUtils-KEXETmH3.js","./basicInterfaces-N86vRvDz.js","./TextureFormat-1mYWTFa-.js","./BufferView-D8MchJMk.js","./mat4f64-q_b6UJoq.js","./Indices-CRH9Snpx.js","./triangle-DSKt0ayJ.js","./sphere-C--KKOt_.js","./mat3f64-B5o_lm6j.js","./vectorStacks-DFiY4KSK.js","./quatf64-aQ5IuZRd.js","./lineSegment-CmILqxlk.js","./VertexAttribute-BfkzOMLV.js","./glsl-Cj7KC756.js","./BindType-BBwFZqyN.js","./ShaderOutput-Bdd80V3g.js","./renderState-BtsWgNs1.js","./orientedBoundingBox-TkA-ujXI.js","./quat-Bt709YlQ.js","./spatialReferenceEllipsoidUtils-CfT-84PB.js","./computeTranslationToOriginAndRotation-MDnbQuSg.js","./plane-BwjI5Zmg.js","./boundedPlane-Dn6I7AEK.js","./projectVectorToVector-MgPSJzsh.js","./projectPointToVector-B7hivpor.js","./ShaderBuilder-Bz0_EU88.js","./NormalAttribute.glsl-C_f6r246.js","./dehydratedFeatureUtils-Df7yHi0T.js","./meshVertexSpaceUtils-SMerZANv.js","./MeshLocalVertexSpace-BkF75Fa6.js","./hydratedFeatures-C87MO-7G.js","./vec3f32-WCVSSNPR.js","./HUDMaterial-DE47FxHo.js","./InterleavedLayout-xg_MCb9l.js","./types-BKo2foNY.js"])))=>i.map(i=>d[i]);
import{ib as ta,ka as Q,ar as ra,k9 as ze,kf as ia,hS as La,eZ as q,aI as O,mf as Aa,_ as he,h8 as na,j$ as se,P as c,Q as we,T as Ga,cw as ie,dy as Pa,dC as Ve,dE as _a,dD as Da,a9 as Fa,hN as ja,jB as Ra,jP as Va,d9 as Ba,a$ as L,ej as Ha,oq as Wa,t2 as k,ko as Ua,k5 as Be,kk as He,bg as qa,aK as Ya,b6 as Ja,eG as Me,eV as Za,eJ as We,b2 as ka,hV as Xa}from"./index-oQclEyX3.js";import{O as Ka}from"./InterleavedLayout-xg_MCb9l.js";import{n as w,u as ee,r as Ue,o as Te,t as Qa,C as eo}from"./ShaderOutput-Bdd80V3g.js";import{n as G,a as M,t as pe}from"./NormalAttribute.glsl-C_f6r246.js";import{a5 as ao,a6 as oo,a7 as F,a8 as to,a9 as ro,aa as io,ab as le,ac as no,ad as so,a1 as lo,ae as co,af as uo,g as D,k as ae,_ as V,ag as B,ah as H,b as K,h as $,ai as W,r as mo,e as ho,aj as po,A as R,ak as vo,al as sa,d as la,am as ca,an as da,ao as fo,v as Oe,x as ve,ap as ua,aq as go,q as ce,ar as xo,as as bo,at as qe,au as Se,l as wo,o as z,av as p,aw as Ie,ax as Ee,ay as de,a2 as Mo,az as To,aA as So,i as Le,aB as yo,c as Co,aC as ma,$ as ue,aD as ha,aE as pa,f as va,a as fa,aF as ga,aG as me,aH as xa,K as No,aI as $o,aJ as Eo,F as zo,aK as Oo,aL as Io,aM as Lo,aN as Ao,aO as Go,aP as Po,z as _o,B as _,C as m,D as Do,E as ye,aQ as Fo,N as jo,aR as Ro,aS as Vo,aT as Bo,O as Ho,W as Wo}from"./OutputColorHighlightOID.glsl-i058ZB5n.js";import{n as i,t as v}from"./glsl-Cj7KC756.js";import{i as N,a as Ye,e as oe,n as te}from"./basicInterfaces-N86vRvDz.js";import{e as x}from"./VertexAttribute-BfkzOMLV.js";import{e as Ae,r as Y}from"./mat3f64-B5o_lm6j.js";import{r as Je}from"./mat4f64-q_b6UJoq.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-Bz0_EU88.js";import{B as Ge,g as Pe,f as Uo}from"./renderState-BtsWgNs1.js";function qo(e){e.vertex.code.add(i`
...
}`);break;case M.ScreenDerivative:e.vertex.code.add(i`void forwardNormal() {}`);break;default:ta(a.normalType);case M.COUNT:}}let Zo=class extends ao{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Ae()}},ko=class extends to{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Ae(),this.toMapSpace=ia()}};function wa(e){e.vertex.code.add(i`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
}`),s&&n!==R.None&&(e.include(vo,a),t.uniforms.add(l===fe.Pass?new $("normalTexture",(h=>h.textureNormal)):new sa("normalTexture",(h=>h.textureNormal))),d&&(t.uniforms.add(new la("scale",(h=>h.scale??Aa))),t.uniforms.add(new F("normalTextureTransformMatrix",(h=>h.normalTextureTransformMatrix??Y)))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
}`))}const aa=O(),A=ia();function mt(e){e.code.add(i`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG) {
