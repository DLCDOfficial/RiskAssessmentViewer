import{i9 as ta,k7 as Q,av as ra,k6 as ze,kc as ia,hQ as Ga,fc as Y,aM as z,mc as Da,_ as he,h6 as na,jY as se,M as c,N as Me,P as ja,cA as ie,dx as Fa,dB as Ve,dD as Ra,dC as Va,ad as Ba,hL as Ha,jC as Wa,jQ as Ua,d8 as Ya,b3 as I,ez as qa,on as Ja,vQ as k,kl as Za,k2 as Be,kh as He,bk as ka,aO as Xa,ba as Ka,eV as Te,f8 as Qa,eY as We,b6 as eo,hT as ao}from"./index-Qd7BCwg9.js";import{O as oo}from"./InterleavedLayout-BXbdqc6w.js";import{n as w,u as ee,r as Ue,o as Se,t as to,C as ro}from"./ShaderOutput-Bdd80V3g.js";import{n as L,a as M,t as pe}from"./NormalAttribute.glsl-BpAfhRtD.js";import{aY as io,aZ as no,a_ as j,a$ as so,b0 as lo,b1 as co,a8 as le,b2 as uo,b3 as mo,a1 as ho,ad as po,b4 as vo,g as D,k as ae,_ as V,aq as B,b5 as H,b as K,h as $,as as W,r as fo,e as go,b6 as xo,A as R,b7 as bo,ag as sa,d as la,aa as ca,aW as da,ae as wo,v as _e,x as ve,ac as ua,b8 as Mo,q as ce,aL as To,ah as So,ai as Ye,a5 as ye,l as yo,o as E,b9 as p,aK as Ie,a6 as Ee,a7 as de,a2 as Co,ba as No,bb as $o,i as Ae,bc as Oo,c as Eo,bd as ma,$ as ue,be as ha,ar as pa,f as va,a as fa,at as ga,ab as me,bf as xa,K as zo,au as _o,ay as Io,F as Ao,az as Lo,aA as Po,aB as Go,av as Do,aw as jo,ax as Fo,z as Ro,B as G,C as m,D as Vo,E as Ce,aC as Bo,N as Ho,ap as Wo,aU as Uo,aD as Yo,O as qo,W as Jo}from"./OutputColorHighlightOID.glsl-uG3ATKDG.js";import{i as N,a as qe,e as oe,n as te}from"./basicInterfaces-N86vRvDz.js";import{e as x}from"./VertexAttribute-BfkzOMLV.js";import{B as Le,g as Pe,f as Zo}from"./renderState-Doz4ZG7p.js";import{n as i,t as v}from"./glsl-Cj7KC756.js";import{a as fe}from"./BindType-BBwFZqyN.js";import{i as ge}from"./ShaderBuilder-DhrzHhVj.js";import{e as Ge,r as q}from"./mat3f64-B5o_lm6j.js";import{r as Je}from"./mat4f64-q_b6UJoq.js";import"./boundedPlane-QF1nEF7M.js";import"./sphere-BXbb1AHK.js";function ko(e){e.vertex.code.add(i`
...
}`)):(e.fragment.uniforms.add(new po("colorMixMode",(t=>vo[t.colorMixMode]))),e.vertex.code.add(i`vec4 getSymbolColor() { return vec4(1.0); }
...
}`))}const aa=z(),A=ia();function pt(e){e.code.add(i`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG) {
...
}`)}function je(e,a){e.include(Ie),a.pbrMode!==p.Normal&&a.pbrMode!==p.Schematic&&a.pbrMode!==p.Simplified&&a.pbrMode!==p.TerrainWithWater||(e.code.add(i`float normalDistribution(float NdotH, float roughness)
{
...
return c2 * a004 + r.zw;
}`)),a.pbrMode!==p.Normal&&a.pbrMode!==p.Schematic||(e.include(pt),e.code.add(i`struct PBRShadingInfo
{
float NdotV;
float LdotH;
float NdotNG;
...
}`)}function vt(e){e.code.add(i`float mapChannel(float x, vec2 p) {
